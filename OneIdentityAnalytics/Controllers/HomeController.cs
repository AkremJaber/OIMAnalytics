...
namespace OneIdentityAnalytics.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult RemoveTenantHasPerson(string UID_CCCTenantsHasPersons,string UID_Person)
        {
            AppOwnsDataDBService.DeleteTenantHasPerson(UID_CCCTenantsHasPersons);
            return RedirectToAction("TenantsHasPersons", new {UID_Person = UID_Person.ToString() }) ;
        }
        ...
        public IActionResult TenantsHasPersons(string UID_Person)
        {
            var model = AppOwnsDataDBService.GetTenantsHasPersons(UID_Person);
            return View(model);
        }
